...
| 상태 | **D1·D2 모두 v0.3.13에서 수정됨** (작성 시점에는 미수정) |
...
> **후속 (2026-08-18, v0.3.13)**: D1과 D2가 모두 수정되었고, §5의 특성 테스트 2건은 정정된 값을 단언하도록 교체되었다. 아래 본문은 **수정 이전 시점의 기록**이며, 보고서는 스냅샷이므로 갱신하지 않는다. 현재 코드의 동작은 CHANGELOG와 테스트를 참조할 것.
